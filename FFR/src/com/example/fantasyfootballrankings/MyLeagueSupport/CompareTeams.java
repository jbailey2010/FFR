...
public class CompareTeams {
	...
	public static void compareTeamInit()
	{
	    ...
	    ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(ImportLeague.cont, 
	    ...
	    submit.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				{
					Toast.makeText(ImportLeague.cont, "Please select different teams", Toast.LENGTH_SHORT).show();
				}
			}
	    });
	}
	...
	public static void compareTeamOutput(String team1, String team2)
	{
		...
		int counter = 0;
		dataSet[counter++] = new GraphViewData(counter, max - TeamList.rankPAAStart(ImportLeague.newImport, t1));
		dataSet[counter++] = new GraphViewData(counter, max - TeamList.rankQBStart(ImportLeague.newImport, t1));
		dataSet[counter++] = new GraphViewData(counter, max - TeamList.rankRBStart(ImportLeague.newImport, t1));
		dataSet[counter++] = new GraphViewData(counter, max - TeamList.rankWRStart(ImportLeague.newImport, t1));
		dataSet[counter++] = new GraphViewData(counter, max - TeamList.rankTEStart(ImportLeague.newImport, t1));
		dataSet[counter++] = new GraphViewData(counter, max - TeamList.rankDStart(ImportLeague.newImport, t1));
		dataSet[counter++] = new GraphViewData(counter, max - TeamList.rankKStart(ImportLeague.newImport, t1));
		...
		counter = 0;
		dataSet2[counter++] = new GraphViewData(counter, max - TeamList.rankPAAStart(ImportLeague.newImport, t2));
		dataSet2[counter++] = new GraphViewData(counter, max - TeamList.rankQBStart(ImportLeague.newImport, t2));
		dataSet2[counter++] = new GraphViewData(counter, max - TeamList.rankRBStart(ImportLeague.newImport, t2));
		dataSet2[counter++] = new GraphViewData(counter, max - TeamList.rankWRStart(ImportLeague.newImport, t2));
		dataSet2[counter++] = new GraphViewData(counter, max - TeamList.rankTEStart(ImportLeague.newImport, t2));
		dataSet2[counter++] = new GraphViewData(counter, max - TeamList.rankDStart(ImportLeague.newImport, t2));
		dataSet2[counter++] = new GraphViewData(counter, max - TeamList.rankKStart(ImportLeague.newImport, t2));
