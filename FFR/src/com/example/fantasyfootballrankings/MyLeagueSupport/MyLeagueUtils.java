...
public class MyLeagueUtils 
{
	 ...
	 * @param key 
	 */
	public static void getRoster(final Context cont, final Storage holder, final Roster dummyRoster, final String key, final ImportedTeam newImport)
	{
		isFirst = true;
		...
		team.setSelection(quantitiesTeam.indexOf(String.valueOf(dummyRoster.teams)));
	 ...
	 * @param scoring
	 */
	public static void passSettings(final Context cont, final Storage holder, final Scoring dummyScoring, final String key)
	{
		final Dialog dialog = new Dialog(cont, R.style.RoundCornersFull);
		dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
		...
		yards.setText(String.valueOf(dummyScoring.passYards), TextView.BufferType.EDITABLE);
		tds.setText(String.valueOf(dummyScoring.passTD), TextView.BufferType.EDITABLE);
		ints.setText(String.valueOf(dummyScoring.interception), TextView.BufferType.EDITABLE);
		...
		toRun.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				if(ManageInput.isInteger(yardStr) && ManageInput.isInteger(tdStr) && ManageInput.isInteger(intStr))
				{
	 ...
	 * @param scoring
	 */
	public static void runSettings(final Context cont, final Storage holder, final Scoring dummyScoring, final String key)
	{
		final Dialog dialog = new Dialog(cont, R.style.RoundCornersFull);
		dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
		...
		yards.setText(String.valueOf(dummyScoring.rushYards), TextView.BufferType.EDITABLE);
		tds.setText(String.valueOf(dummyScoring.rushTD), TextView.BufferType.EDITABLE);
		ints.setText(String.valueOf(dummyScoring.fumble), TextView.BufferType.EDITABLE);
	 ...
	 * @param scoring
	 */
	public static void recSettings(final Context cont, final Storage holder, final Scoring dummyScoring, final String key)
	{
		final Dialog dialog = new Dialog(cont, R.style.RoundCornersFull);
		dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
		...
		yards.setText(String.valueOf(dummyScoring.recYards), TextView.BufferType.EDITABLE);
		tds.setText(String.valueOf(dummyScoring.recTD), TextView.BufferType.EDITABLE);
		ints.setText(String.valueOf(dummyScoring.catches), TextView.BufferType.EDITABLE);
