...
/**
 * This class handles basic queries, returning basic info to be handled by other
 * functions
 * 
 * @author Jeff
 * 
...
public class HandleBasicQueries {
	...
	public static List<String> handleListsNoUA(String url, String params)
			throws IOException {
		List<String> elems = new ArrayList<String>();
	...
	/**
	 * This is the query function for a list called twice+ with the same page
	 * 
	 * @param url
	 *            the url to be parsed
	 * @return the text that was parsed
	 * @throws IOException
	 */
	public static List<String> handleListsMulti(Document doc, String url,
	...
	/**
	 * Handles the queries to a table called multiple times by some function
	 * 
	 * @param url
	 *            the url to be parsed
	 * @param params
	 *            the class of the table to be parsed
	 * @return the text from the table
	 * @throws IOException
	 */
	public static List<String> handleTablesMulti(Document doc, String url,
			String params) throws IOException {
		List<String> elems = new ArrayList<String>();
