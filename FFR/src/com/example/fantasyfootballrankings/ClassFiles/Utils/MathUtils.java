...
public class MathUtils {
	...
	public static double getLeverage(PlayerObject player, Storage holder,
		...
		return Double
				.parseDouble(df
						.format(((player.values.points / maxProj) / (player.values.secWorth / maxWorth))));
	...
	public static void getPAA(Storage holder, Context cont) {
		...
		double dTotal = 0.0;
		double kTotal = 0.0;
		PriorityQueue<PlayerObject> qb = new PriorityQueue<PlayerObject>(300,
		...
		PriorityQueue<PlayerObject> rb = new PriorityQueue<PlayerObject>(300,
				new Comparator<PlayerObject>() {
					@Override
					public int compare(PlayerObject a, PlayerObject b) {
						if (a.values.worth > b.values.worth) {
		...
		PriorityQueue<PlayerObject> wr = new PriorityQueue<PlayerObject>(300,
				new Comparator<PlayerObject>() {
					@Override
					public int compare(PlayerObject a, PlayerObject b) {
						if (a.values.worth > b.values.worth) {
		...
		PriorityQueue<PlayerObject> te = new PriorityQueue<PlayerObject>(300,
				new Comparator<PlayerObject>() {
					@Override
					public int compare(PlayerObject a, PlayerObject b) {
						if (a.values.worth > b.values.worth) {
		...
		PriorityQueue<PlayerObject> k = new PriorityQueue<PlayerObject>(300,
				new Comparator<PlayerObject>() {
					@Override
					public int compare(PlayerObject a, PlayerObject b) {
						if (a.values.worth > b.values.worth) {
		...
		PriorityQueue<PlayerObject> def = new PriorityQueue<PlayerObject>(300,
				new Comparator<PlayerObject>() {
					@Override
					public int compare(PlayerObject a, PlayerObject b) {
						if (a.values.worth > b.values.worth) {
