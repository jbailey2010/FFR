...
public class TeamAnalysis 
{
	 ...
	 */
	public void manageStarters(String[] qb, String[] rb, String[] wr, String[] te, String[] d, String[] k){
		...
		if(r.flex != null && (r.flex.rbwr > 0 || r.flex.rbwrte > 0 || r.flex.op > 0)){
			...
			List<PlayerObject> best = getFlexOptions(qbNext, rbNext, wrNext, teNext, qbConsider, rbConsider, wrConsider, teConsider);
	 ...
	 */
	public List<PlayerObject> getFlexOptions(List<PlayerObject> qbNext, List<PlayerObject> rbNext, List<PlayerObject> wrNext, List<PlayerObject> teNext,
			int qbConsider, int rbConsider, int wrConsider, int teConsider){
	...
	/**
	 * Gets the valid players who aren't yet in the starting roles to consider for flex roles 
	 */
	...
	public double getStarterPAA(){
		return getPosPAA(qbStarters) + getPosPAA(rbStarters) + getPosPAA(wrStarters) + getPosPAA(teStarters) + getPosPAA(dStarters) + getPosPAA(kStarters);
	}
	...
	public double getStarterProj(){
		return getPosProj(qbStarters) + getPosProj(rbStarters) + getPosProj(wrStarters) + getPosProj(teStarters) + getPosProj(dStarters) + getPosProj(kStarters);
	}
