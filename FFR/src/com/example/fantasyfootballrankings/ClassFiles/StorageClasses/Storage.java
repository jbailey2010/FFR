...
public class Storage {
	...
	/**
	 * This sets up the priority queue and it's subsequent comparator. No
	 * parameters are necessary, and the playerNames array doesn't need
	 * initialization.
	 */
	...
	/**
	 * This iterates through the priority queue and sees if the name exists
	 * within the priority queue already
	 * 
	 * @param holder
	 *            the storage to be parsed through
	 * @param name
	 *            the PASSED IN STANDARDIZED name
