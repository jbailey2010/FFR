...
public class Draft
{
	 ...
	 */
	public void saveDraft(final Storage holder, final Context cont) 
	{
	    ...
	    submit.setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View v) {
				saveDraftConfirmed(cont, holder);
				dialog.dismiss();
			}
	    });
	}
	 ...
	 */
	public void saveDraftConfirmed(final Context cont, final Storage holder) 
	{
		final Dialog dialog = new Dialog(cont, R.style.RoundCornersFull);
		dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
	    ...
	    submit.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				{
					Toast.makeText(cont, "Please enter a team name", Toast.LENGTH_SHORT).show();
				}
			}
	    });
	}
