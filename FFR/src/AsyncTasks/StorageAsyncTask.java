...
public class StorageAsyncTask
{
	...
	public class WriteDraft extends AsyncTask<Object, Void, Void> 
	{
	    ...
	    protected Void doInBackground(Object... data) 
	    {
	    	...
	    	{
	    		String players = new String(Double.toString(player.values.worth));
		    	//StringBuilder players = new StringBuilder(10000);
	    		players.concat(Double.toString(player.values.worth));
	    		players.concat("&&");
	    		players.concat(Double.toString(player.values.count));
	    		players.concat("&&");
	    		players.concat(player.info.name);
	    		players.concat("&&");
	    		players.concat(player.info.team);
	    		players.concat("&&");
	    		players.concat(player.info.position);
	    		players.concat("&&");
	    		players.concat(player.info.adp);
	    		players.concat("&&");
	    		players.concat(player.info.contractStatus);
	    		players.concat("&&");
	    		players.concat(player.info.age);
	    		players.concat("&&");
	    		players.concat(player.stats);
	    		players.concat("&&");
	    		players.concat(player.injuryStatus);
	    		players.concat("&&");
	    		players.concat(Double.toString(player.values.ecr));
	    		players.concat("&&");
	    		players.concat(Double.toString(player.risk));
	    		players.concat("&&");
	    		players.concat(Double.toString(player.values.points));
	    		players.concat("&&");
	    		players.concat(Double.toString(player.values.paa));
	    		players.concat("&&");
	    		players.concat(Double.toString(player.values.rosRank));
	    		players.concat("&&");
	    		players.concat(player.values.startDists.get("Bad") + "," + player.values.startDists.get("Good") + "," + player.values.startDists.get("Great"));
